...
namespace Ambrosia.Common.ModuleManagement
{
        ...
        where T : SingletonModule<T>
    {
        ...
        public static T Instance
        {
            get
            {
                ...
                if (!Application.isPlaying)
                {
                    if (!_instance)
                    {
                        throw new AmbrosiaCommonException(EditorNoInstanceExceptionMessage);
                    }
                ...
                return _instance ? _instance : throw new AmbrosiaCommonException(NoInstanceExceptionMessage);
            }
        }
        ...
        internal sealed override void Bootstrap()
        {
            if (_instance)
            {
                throw new AmbrosiaCommonException(MultipleInstanceExceptionMessage);
            }
